...
**層級數值越小 = 結合越緊密（優先權越高）**
本表與 **[SPEC_14: 正式語法](./SPEC_14_Formal_Grammar.md)** 完全對齊。
...
| **[SPEC_04](./SPEC_04_Navigation_and_Duality.md)** | 導航 | ⭐⭐ | 詞法視界、水晶透視 |
...
| **[SPEC_10](./SPEC_10_Evolution_and_Commit.md)** | 演化 | ⭐⭐ | 時間視界、核心態射 |
...
| **[SPEC_17](./SPEC_17_Self_Evolution.md)** | 自我演化 | ⭐⭐⭐⭐⭐ | 創世算法、N-1 自舉 |
...
| **[GUIDE_02](./GUIDE_02_Engine_Optimization.md)** | 引擎優化 | ⭐⭐⭐ | 熱帶幾幾何優化與啟發式搜尋策略 |
